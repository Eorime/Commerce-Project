    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Electronics', 'Electronics'), ('Books', 'Books'), ('Household', 'Household'), ('Furniture', 'Furniture'), ('Clothing', 'Clothing'), ('Other', 'Other')], max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bidStarterAmount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
